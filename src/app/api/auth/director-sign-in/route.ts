 ...
 * oracle), and a per-IP rate limit throttles brute force — the same backstop
 * as /api/auth/verify-code. Firebase Auth itself also throttles repeated
 * password failures for an account.
 */
